...
| `system_template`, `system_template_inline` | string | built-in default | Override the classifier's system prompt. Leave unset to use the [embedded default](../internal/spamfilter/ai/defaults/) (see [Security model](../README.md#security-model)). This can be helpful if you want to adjust e.g. suspected spam instructions tailored to your form content. |
